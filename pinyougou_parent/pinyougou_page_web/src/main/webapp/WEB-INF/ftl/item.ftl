						...
						<div id="specification" class="summary-wrap clearfix">
							...
							<dl>
								...
								<#list spec.attributeValue as value>
									<dd><a href="javascript:;" class="{{isSelected('${spec.attributeName}','${value}')?'selected':''}}" ng-click="updateSpec('${spec.attributeName}','${value}')">${value}<span title="点击取消选择">&nbsp;</span></a></dd>
								</#list>
							</dl>
							</#list>
						</div>
