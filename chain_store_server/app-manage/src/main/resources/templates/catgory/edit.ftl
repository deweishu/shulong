                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="frm" enctype="multipart/form-data" method="post" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="name" name="name" value="${(category.name)!''}" class="form-control" type="text">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="cateSort" name="cateSort" value="${(category.cateSort)!''}" class="form-control" type="text">
                            </div>
                        </div>
                        <div class="form-group">
